#include "stm32f10x.h"
/*******************************************************/
//	LCD Port(Pin)			ARMada Port(Connector Pin)
//	DB7 (14)					PB3 		(7)  connector to lcd
//	DB6 (13)					PB5 		(6)  connector to lcd
//	DB5 (12)					PB7			(5)  connector to lcd
//	DB4 (11)					PB8			(4)  connector to lcd
//	E   (6)						PB9			(3)  connector to lcd
//
//	RW  (5)						GND			(9) connector to lcd
//	RS	(4)						PB4			(8) connector to lcd
//
//	Vss	(1)						GND			(2)	connector to lcd
//	Vdd	(2)						3.3V		(1) connector to lcd
/********************************************************/

/*******************************************************/
//	LCD Port(Pin)			ARMadaLightBlack Port(Connector Pin)
//	DB7 (14)					PB3 				(7)  connector to lcd
//	DB6 (13)					PB5 				(6)  connector to lcd
//	DB5 (12)					PB7					(5)  connector to lcd
//	DB4 (11)					PB8					(4)  connector to lcd
...
//
//	RW  (5)						no connect
//	RS	(4)						PB4					(9) connector to lcd
//
//	Vss	(1)						GND					(2)	connector to lcd
//	Vdd	(2)						pwrSwitch 3.3V		(8) connector to lcd
/********************************************************/




//LCD R/W pin connect to GNG
/////should be defined by user /////
#define LCD_PORT GPIOB
#define LCD_CD 4//15 //4 (нужно будет перенести на PB4)
#define LCD_EN 9
#define LCD_DB4 8
#define LCD_DB5 7
#define LCD_DB6 5
